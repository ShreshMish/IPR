...
save_dated <- function(data, name = " ", folder, dated = "YES", csv = "NO") {
  main_path <- paste0("11 - Panel setting/", folder)
  dated_path <- paste0("11 - Panel setting/", folder, "/Dated/")
...
geographic_exposure_data <- readRDS("6 - Financial geog/Output/Company_geog_exposure_results.rds")
...
market_parameter_data <- readRDS("8 - Market parameters/Output/Market_parameter_data.rds")

# Read in emissions-by-product data
product_emissions_data <- readRDS("10 - Emissions intensity/Output/Product_level_emissions_data.rds")
...
save_dated(carbon_cost_data, "Carbon_cost_calculations_full", folder = "Interim", csv = "NO")
...
save_dated(carbon_cost_data, "Carbon_costs", folder = "Output", csv = "NO")
...
save_dated(model_panel, "Model_panel", folder = "Output", csv = "NO")