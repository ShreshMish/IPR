...
mac_data_cleaned <- readRDS(paste0(main_save_folder, "/Output/MAC_curve_cleaned_2016USD_data.rds"))
...
mac_curve_chart <- function(mac_region = region_code, mac_sector = sector_code, mac_year = year,
  ...
  save_name <- paste0(main_save_folder, "/Output/MAC curve plots/", mac_region, "_", mac_sector, "_", mac_year,
                      "_", mac_cost_cap, ".png")
