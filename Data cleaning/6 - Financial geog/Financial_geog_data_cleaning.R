...
save_dated(missing_value_companies, "Missing_value_companies", folder = "Interim", csv = "YES")
...
save_dated(domestic_reporting_companies, "Domestic_reporting_companies", folder = "Interim", csv = "YES")
...
financial_domestic_rename <- read_csv("6 - Financial geog/Input/TR domestic geogs renamed.csv") %>%
...
save_dated(financial_data, "TR_geographic_exposure_full_data", folder = "Interim", csv = "YES")
...
save_dated(unique_geographies_data, "TR_geographies_full_list", folder = "Interim", csv = "YES")
