...
tiam_ev_new_capa <- read_excel("0 - Scenarios/Input/Vivid_scenario_runs.xls",
...
evo_raw_ev_total_stock <- read_excel("0 - Scenarios/Input/Global_EV_Outlook_VE.xlsx",
                                    sheet = "R1. IEA EVO deployment", range = "$A$9:$C$20")

# Read in IEA EV sales scenario data (2017 Energy Technology Perspectives)
etp_raw_ev_total_sales <- read_excel("0 - Scenarios/Input/ETP2017_EVsales_VE.xlsx",
...
bp_raw_ev_data <- read_excel("0 - Scenarios/Input/BPOutlook2017_EVdata_VE.xlsx",
...
save_dated(tiam_fossil_sales, "ICE_new_capacity", folder = "Output", csv = TRUE)