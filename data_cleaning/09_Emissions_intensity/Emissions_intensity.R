...
##### Dependencies:       1.  Results from CO2 emissions data cleaning: "02_CO2_emissions/Output/Trucost_cleaned_emissions_data.rds"
#####                         Older files can be found in the ".../Dated/" folder
#####                     2.  Results from Fossil fuel prod data product exposure analysis: "08_Fossil_fuel_prod/Output/Market_exposure_results_oilandgas.rds"
...
emissions_data <- readRDS(path_to_data_file("02_CO2_emissions/Output/Trucost_cleaned_emissions_data.rds"))
...
save_dated(market_status, "09_Emissions_intensity/Interim/Market emissions intensity status", csv = TRUE)
...
save_dated(market_emissions_intensity_data, "09_Emissions_intensity/Output/Market_emissions_intensities", csv = TRUE)
...
save_dated(disaggregated_emissions_data, "09_Emissions_intensity/Output/Product_level_emissions_data", csv = TRUE)
