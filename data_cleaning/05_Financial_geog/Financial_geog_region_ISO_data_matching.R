...
match_geog_region_ISO_codes <- function(unique_geographies, region_iso_code_data, gdp_iso_code_data)
{
  ...
  save_dated(unique_geographies, "05_Financial_geog/Interim/TR_unmapped_geographies", csv = TRUE)
  ...
  save_dated(region_iso_code_data, "05_Financial_geog/Interim/TR_mapped_geographies_wide", csv = TRUE)
  
  region_iso_code_data %<>%
    gather(key = "region", value = "Inclusion", -(ISO_code:Country))
  
  return(region_iso_code_data)
}
