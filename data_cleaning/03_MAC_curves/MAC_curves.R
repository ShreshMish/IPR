...
mac_data_raw <- read_excel(path_to_data_file("03_MAC_curves/Input/MAC curve data.xlsx"), sheet = "W5. Panel data for R export",
                           range = "$A$5:$I$4961", col_names = TRUE)

save_dated(mac_data_raw, "03_MAC_curves/Interim/MAC_curve_raw_data")
...
save_dated(mac_data_cleaned, "03_MAC_curves/Output/MAC_curve_cleaned_2016USD_data", csv = TRUE)